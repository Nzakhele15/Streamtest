...
paths = {
    ...
    "wordcloud": os.path.join(base_dir, 'images', 'wordcloud_by_category.png'),
    "imbalanced_dist": os.path.join(base_dir, 'images', 'imbalanced_distribution.png'),
    "balanced_class_dist": os.path.join(base_dir, 'images', 'balanced_class_category.png'),
    "stone_image": os.path.join(base_dir, 'images', 'stone.png'),
    "screenshot_image": os.path.join(base_dir, 'images', 'Screenshot_2024-07-04_203832.png')
}
